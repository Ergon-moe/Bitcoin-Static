...
This library is used for consensus critical cryptographic operations on the Bitcoin Cash network. It is maintained within the Bitcoin Static repository while following upstream sources which include Bitcoin Core and Bitcoin ABC.
Developers who want to contribute may do so either through the Bitcoin Static project, or at [reviews.bitcoinabc.org](https://reviews.bitcoinabc.org/), or through Bitcoin Core. Use at your own risk.
