...
enum ServiceFlags : uint64_t {
    ...
    // chain. It is currently set by all Bitcoin Static non pruned nodes, and is
    // unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo
    // protocol request. Bitcoin Static does not support this but a patch set
    ...
    // connections. Bitcoin Static nodes used to support this by default, without
