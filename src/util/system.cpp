...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitcoin-Static
// Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitcoin-Static
// Mac: ~/Library/Application Support/Bitcoin-Static
// Unix: ~/.bitcoin-static
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoin-Static";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitcoin-Static";
#else
    // Unix
    return pathRet / ".bitcoin-static";
#endif
#endif
}
