...
Bitcoin Static does not have an automated process set up to assist
with translation.

The description retained below is for the Bitcoin Core project.

Bitcoin Static developers may use translation data made available by
...
Translations in Bitcoin Static
---------------------------------
