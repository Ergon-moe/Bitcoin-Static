...
```
> bitcoin-cli getblockheader 1000
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getblockheader", "params": [1000] }' -H 'content-type: text/plain;' http://127.0.0.1:8332/
